...
Typically, MDPs are solved by reinforcement learning (e.g., Q-learning,
REINFORCE). However, given our exponential search space, such trail-and-error
...
\HHNote{Explain how the pruning is done}
...
times with random starting state.  
After example collection, we train the policy (predict the optimal Q-values) by
ridge regression.
